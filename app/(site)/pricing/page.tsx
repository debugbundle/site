...
const tiers = [
  {
    ...
    features: [
      ...
      'Webhooks',
      'Always-on probes',
      '1 health check /project',
      '5 minute minimum health-check interval',
    ],
    excluded: [
  ...
  },
  {
    ...
    features: [
      ...
      'Webhooks',
      'Always-on probes',
      '5 health checks /project',
      '60s minimum health-check interval',
      'Remote probe activation',
      'Automated improvement bundles',
      'GitHub automation',
  ...
  },
  {
    ...
    features: [
      ...
      'Webhooks',
      'Always-on probes',
      '25 health checks /project',
      '30s minimum health-check interval',
      'Remote probe activation',
      'Automated improvement bundles',
      'GitHub automation',
