...
export function DogfoodingBootstrap(): null {
  useEffect(() => {
    initializeSiteDogfooding({
      ...
      ...(process.env["NEXT_PUBLIC_DEBUGBUNDLE_DOGFOOD_ANALYTICS_ENABLED"] === undefined
        ? {}
        : { NEXT_PUBLIC_DEBUGBUNDLE_DOGFOOD_ANALYTICS_ENABLED: process.env["NEXT_PUBLIC_DEBUGBUNDLE_DOGFOOD_ANALYTICS_ENABLED"] })
    });
  }, []);
