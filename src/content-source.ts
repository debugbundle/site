...
const docsCollection = await create.docs('docs', 'content/docs', {
  './meta.json': {
    ...
    pages: [
      ...
      'project-setup/connect-to-cloud',
      'capture-policy',
      'self-hosting',
      '---Advanced Features---',
      'probes',
      ...
      '---Reference---',
      '[Reference Index](/docs/v1/reference)',
      ...
      '[Profile Schema](/docs/v1/reference/profile-schema)',
      '[Error Codes](/docs/v1/reference/error-codes)',
      '---Help---',
      'troubleshooting',
      'faq',
    ],
  ...
  './sdks/meta.json': {
    title: 'SDKs',
    pages: ['index', 'node', 'browser', 'browser-relay', 'python', 'php', 'universal-interface'],
  },
