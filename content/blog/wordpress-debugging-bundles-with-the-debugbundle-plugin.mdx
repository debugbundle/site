...
The plugin path avoids requiring Composer, npm, shell access, CDN scripts, or manual browser relay setup. Site admins install DebugBundle from the WordPress.org plugin directory, activate it, open Settings -> DebugBundle, paste the project token, and run backend and frontend test events.
