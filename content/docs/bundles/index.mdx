...
Bundles are generated asynchronously by the worker after events are grouped into incidents.
Generation triggers at specific occurrence thresholds (1, 3, 10 events) and whenever
significant new data arrives.
