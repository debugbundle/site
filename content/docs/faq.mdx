...
| Language | Status |
|---|---|
| Node.js | Released v1.6.0 |
| Browser (JavaScript) | Released v1.6.0 |
| Python | Released v1.3.0 |
| PHP | Released v1.3.0 |
| Java | Released v1.3.0 |
| .NET | Released v1.3.0 |
| Go | Released v1.3.0 |
| Ruby | Released v1.3.0 |
| WordPress | Released v1.4.0 on WordPress.org |
| Android | Released v1.2.0 |
| iOS | Released v1.2.0 |
| React Native | Released v1.2.0 |
