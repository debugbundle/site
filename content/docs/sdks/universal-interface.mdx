...
| Feature | Node.js | Browser | Python | PHP | Java |
|---------|---------|---------|--------|-----|------|
| Status | ✅ Shipped | ✅ Shipped | ✅ Shipped | ✅ Shipped | Pre-release |
| Package | `@debugbundle/sdk-node` | `@debugbundle/sdk-browser` | `debugbundle-python` | `debugbundle/sdk-php` | `com.debugbundle:debugbundle-spring-boot-starter` |
| Framework integrations | Express, Fastify, Next.js | — | Django, Flask, FastAPI | Laravel, Symfony | Spring Boot MVC |
| Logger integrations | pino, winston, bunyan | — | logging, structlog, loguru | Monolog | JUL, Logback |
| Safe backend runtime facts | Full process facts | — | Full process facts | Full process facts | Full process facts |
| Breadcrumbs | — | ✅ | — | — | — |
| Relay handler | Express, Fastify, Next.js | Relay client path | Django, Flask, FastAPI | Laravel, Symfony | Spring Boot route |
| Probes | ✅ | ✅ | ✅ | ✅ | ✅ |
| File transport | ✅ | — | ✅ | ✅ | ✅ |
...
- [Java SDK](/docs/sdks/java) — Full Java and Spring Boot setup
