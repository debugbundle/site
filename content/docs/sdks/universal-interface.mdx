...
| `offline queue` | Android, Swift, React Native | Bounded app-private queue with platform-aware deferred flushing. Used for offline, background, and local/development paths. |
...
| Feature | Node.js | Browser | Python | PHP | Java | .NET | Go | Ruby | Android | Swift | React Native |
|---------|---------|---------|--------|-----|------|------|----|------|---------|-------|--------------|
| Status | Shipped | Shipped | Shipped | Shipped | Shipped | Released v0.1.1 | Shipped | Shipped | Released v0.1.2 | Released v0.1.1 | Released v0.1.1 |
