...
| Capability | Node.js | Browser | Python | PHP | WordPress | Java | .NET | Go | Ruby | Android | Swift | React Native |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Status | Shipped | Shipped | Shipped | Shipped | Shipped via GitHub Releases | Shipped | Released v0.1.1 | Shipped | Shipped | Released v0.1.2 | Released v0.1.1 | Released v0.1.1 |
...
| **Offline queue** | App-private mobile storage | Android, Swift, and React Native offline, background, local, and deferred-flush paths |
...
File transport uses atomic temp-file + rename to prevent partial writes. Android, Swift, and React Native use bounded app-private queues instead of writing directly to `.debugbundle/local/events/`.
