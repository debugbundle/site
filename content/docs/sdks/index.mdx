...
| Capability | Node.js | Browser | Python | PHP |
|---|---|---|---|---|
...
| Unhandled exceptions | Yes | Yes | Yes | Yes |
| Handled exception capture | Yes | Yes | Yes | Yes |
| Request 5xx incident capture | Yes | Yes | Yes | Yes |
| Browser first-party 5xx promotion | N/A | Yes | N/A | N/A |
| Breadcrumbs | No | Yes | No | No |
| Relay support | Server relay exports | Relay client path | Browser relay foundation | Browser relay foundation |
| Remote config and capture policy | Yes | Yes | Yes | Yes |
| Probes | Yes | Yes | Yes | Yes |
| Redaction defaults | Yes | Yes | Yes | Yes |
| Framework integrations | Express, Fastify, Next.js | Browser-native; works with React, Next.js client-side, Vue, Angular, Svelte, and vanilla apps | Django, Flask, FastAPI | Laravel, Symfony |
| Local file transport | Yes | No | Yes | Yes |
