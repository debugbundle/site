...
Planned server SDKs, including C#/.NET, must implement the same relay contract before public docs describe them as full relay-handler compatible. Client/mobile SDKs such as Android, Swift, and React Native do not host browser relay routes.
