...
2. Search for **DebugBundle**.
3. Install and activate the plugin, then open **Settings -> DebugBundle**.
4. Paste your DebugBundle project token and save.
5. Use the backend and frontend test-event buttons to verify delivery.

Manual ZIP installs are available from the [debugbundle-wordpress GitHub releases](https://github.com/debugbundle/debugbundle-wordpress/releases) page if your host or deployment process cannot install from the [WordPress.org plugin directory](https://wordpress.org/plugins/debugbundle/).
