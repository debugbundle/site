...
| SDK | Version | Status |
|-----|---------|--------|
| `@debugbundle/sdk-node` | 0.1.8 | Shipped |
| `@debugbundle/sdk-browser` | 0.1.8 | Shipped |
| `debugbundle-python` | 0.1.6 | Shipped |
| `debugbundle/sdk-php` | 0.1.7 | Shipped |
| `debugbundle-wordpress` | 0.1.7 | Shipped via GitHub Releases |
| `com.debugbundle:debugbundle-spring-boot-starter` | 0.1.0 | Shipped |
