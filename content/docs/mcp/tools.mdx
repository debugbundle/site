...
| Parameter | Type | Description |
|-----------|------|-------------|
| _(none)_ | — | Checks cloud prerequisites and token validity. |
...
| Parameter | Type | Description |
|-----------|------|-------------|
| _(none beyond auth)_ | — | Returns all members of the organization. |
...
| Parameter | Type | Description |
|-----------|------|-------------|
| _(none beyond auth)_ | — | Returns all pending invitations. |
