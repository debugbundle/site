...
<WorkflowDiagram>
  <WorkflowStep title="SDKs and Logs" meta="Input">
    Node.js, Browser, Python, PHP, Java, or existing log files.
  </WorkflowStep>
  <WorkflowStep title="Local Files" meta="Local-only">
    Events land in `.debugbundle/local/events/` and are processed by `debugbundle process`.
  </WorkflowStep>
