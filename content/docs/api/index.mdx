...
| Method | Path | Auth | Description |
|---|---|---|---|
| `GET` | `/v1/projects/:id/members` | Member token | List project members |
| `GET` | `/v1/projects/:id/invites` | Member token | List pending project invites |
| `POST` | `/v1/projects/:id/invite` | Member token | Invite a collaborator |
| `DELETE` | `/v1/projects/:id/invites/:inviteId` | Member token | Cancel a project invite |
| `PATCH` | `/v1/projects/:id/members/:userId` | Member token | Update project member role |
| `DELETE` | `/v1/projects/:id/members/:userId` | Member token | Remove a project member |
...
| Method | Path | Auth | Description |
|---|---|---|---|
| `GET` | `/v1/sdk/config` | Project token | Get SDK config, including capture policy and active probe directives |
...
| Method | Path | Auth | Description |
|---|---|---|---|
| `GET` | `/v1/projects/:id/capture-policy` | Member token | Get current capture policy for a project |
| `PATCH` | `/v1/projects/:id/capture-policy` | Member token | Set capture policy for a project |
