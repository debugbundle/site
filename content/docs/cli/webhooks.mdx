...
|------|------|-------------|
| `--project-id` | `string` | **Required.** Project that owns the webhook. |
...
```bash
debugbundle webhook delete wh_01HDEF... --project-id proj_01HXYZ...
```
...
```bash
debugbundle webhook test wh_01HDEF... --project-id proj_01HXYZ...
```

The test command sends a `verification.passed` event by default. Specify a different event:

```bash
debugbundle webhook test wh_01HDEF... --project-id proj_01HXYZ... --event verification.failed
```
...
```bash
debugbundle webhook deliveries wh_01HDEF... --project-id proj_01HXYZ...
```
...
```bash
debugbundle webhook retry wh_01HDEF... del_01HJKL... --project-id proj_01HXYZ...
```
