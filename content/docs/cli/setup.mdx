...
The generated skill teaches agents the incident-first workflow, profile
validation, browser relay verification, incident resolution hygiene, and when to
evaluate repeated low-value incidents for capture-rule suggestions or
path-scoped client-error capture policy.
