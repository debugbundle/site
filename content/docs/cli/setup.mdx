...
description: "Initialize DebugBundle in your project with the setup command. Understand the scaffold, profile, connection config, and diagnostic tools."
icon: Settings
---
...
This additionally reports undelivered relay spool files and their age.
