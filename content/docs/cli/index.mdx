---
title: "CLI"
description: "Install and authenticate the DebugBundle CLI. Manage incidents, bundles, tokens, webhooks, alerts, and health checks from the terminal."
icon: Terminal
---
...
| `analytics ...` | Query aggregate usage, inspect journeys/opportunities, generate AnalyticsBundles, and manage settings/saved funnels |

See [AnalyticsBundle CLI](/docs/cli/analytics) for the complete analytics workflow and
command groups.
