---
title: "MCP v1 surface summary"
description: "Versioned summary of the shipped DebugBundle MCP surface. Use the main MCP guide for setup, authentication, and workflow details."
---

<Notice title="Primary MCP guide">
  For installation, authentication, and agent workflow setup, start with [MCP Server](/docs/mcp). This page is a versioned summary route for the v1 docs tree.
</Notice>
