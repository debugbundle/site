...
If a project downgrades to Free, saved remote probe activations remain visible in the
management surfaces so owners can see what will resume after upgrading again. They do
not continue shipping while the lower tier is active.
